...
namespace UnityStandardAssets.Characters.ThirdPerson
{
	...
	public class ThirdPersonCharacter : MonoBehaviour
	{
        ...
        public bool ListeningInteraction
        {
            set
            {
                m_Animator.SetBool("InteractionListening", value);
            }
        }
        public bool TalkingInteraction
        {
            set
            { 
                m_Animator.SetBool("InteractionTalking", value);
            }
        }
